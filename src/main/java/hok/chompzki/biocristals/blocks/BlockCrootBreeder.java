...
public class BlockCrootBreeder extends BlockContainer {
    ...
    public void registerBlockIcons(IIconRegister p_149651_1_)
    {
        ...
        this.top_icon = p_149651_1_.registerIcon(BioCristalsMod.MODID + ":" + BlockNest.NAME +"_top");
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
		...
		player.openGui(BioCristalsMod.instance, 105, world, ent.xCoord, ent.yCoord, ent.zCoord);
