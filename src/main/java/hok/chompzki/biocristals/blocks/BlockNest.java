...
public class BlockNest extends BlockContainer {
	...
	public static final String NAME = "blockNest";
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
		...
		TileNest ent = (TileNest) world.getTileEntity(x, y, z);
		player.openGui(BioCristalsMod.instance, 104, world, ent.xCoord, ent.yCoord, ent.zCoord);
    ...
    {
    	TileNest tileentitychest = (TileNest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
