...
import hok.chompzki.biocristals.ClientProxy;
import hok.chompzki.biocristals.MaterialGhost;
...
public class BlockReplacer extends BlockContainer{
	
	public static final String NAME = "blockReplacer";
