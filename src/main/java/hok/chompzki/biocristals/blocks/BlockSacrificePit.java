...
public class BlockSacrificePit extends BlockContainer {
	
	public static final String NAME = "blockSacrificePit";
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(BioCristalsMod.MODID + ":" + NAME+"_side");
        this.side_icon = p_149651_1_.registerIcon(BioCristalsMod.MODID + ":" + NAME+"_side");
        this.top_icon = p_149651_1_.registerIcon(BioCristalsMod.MODID + ":" + NAME +"_top");
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
    	...
    	TileSacrificePit ent = (TileSacrificePit) world.getTileEntity(x, y, z);
		player.openGui(BioCristalsMod.instance, 108, world, ent.xCoord, ent.yCoord, ent.zCoord);
    ...
    {
    	TileSacrificePit tileentitychest = (TileSacrificePit)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
