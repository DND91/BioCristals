...
public abstract class GuiCraftingHelper extends Gui {
    ...
    public GuiCraftingHelper(Minecraft minecraft, Research research){
    	this.articleFontRenderer = new ArticleFontRenderer(minecraft, minecraft.gameSettings, BioCristalsMod.MODID + ":textures/font/ascii.png", minecraft.renderEngine, false);
