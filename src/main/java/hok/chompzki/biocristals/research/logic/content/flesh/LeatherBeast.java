...
public class LeatherBeast extends ArticleContent {
	...
	public String textOnPage(EnumContent content, int p){
		...
		case 1:
			s += "    ~ Crystallization ~\n";
			s += KnowledgeDescriptions.transformWeakFlesh(new ItemStack(ItemRegistry.bioReagent), new EntityHorse(Minecraft.getMinecraft().theWorld), new ItemStack(ItemRegistry.attuner));
			s += "       ~ Creation ~\n\n";
	...
	public GuiCraftingHelper getFaved() {
		return new GuiFleshRecipe(Minecraft.getMinecraft(), code, new ItemStack(ItemRegistry.bioReagent), new EntityHorse(Minecraft.getMinecraft().theWorld), new ItemStack(ItemRegistry.attuner), new ItemStack(Items.leather));
	}
}
