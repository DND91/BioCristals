...
public class LeatherHound extends ArticleContent {
	...
	public String textOnPage(EnumContent content, int p){
		...
		case 1:
			s += "    ~ Crystallization ~\n";
			s += KnowledgeDescriptions.transformWeakFlesh(new ItemStack(ItemRegistry.bioReagent), new EntityCow(Minecraft.getMinecraft().theWorld), new ItemStack(ItemRegistry.attuner));
			s += "       ~ Creation ~\n\n";
			s += KnowledgeDescriptions.transformOutput(new ItemStack(Items.leather));
			s += "\n";
	...
	public GuiCraftingHelper getFaved() {
		return new GuiFleshRecipe(Minecraft.getMinecraft(), code, new ItemStack(ItemRegistry.bioReagent), new EntityCow(Minecraft.getMinecraft().theWorld), new ItemStack(ItemRegistry.attuner), new ItemStack(Items.leather));
	}
}
