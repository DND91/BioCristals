...
public class GuiCraft extends GuiCraftingHelper {
	...
	public void drawGui(GuiScreen currentScreen, Minecraft mc, World world, EntityPlayer player, ItemStack currentStack, int mouseX, int mouseY, float renderPartialTicks) {
		...
		arc.mainBody.draw(new Cursor(), 0, (int) (this.xPosition + 10 * scale * xScale), this.yPosition + 15, this, articleFontRenderer, true, scale * xScale);
		arc.mainBody.drawOverlay(new Cursor(), 0, (int) (this.xPosition + 10 * scale * xScale), this.yPosition + 15, this, articleFontRenderer, true, scale * xScale, mouseX, mouseY);
