...
public class SlotTokenAssemblerResult extends Slot {
    ...
    public SlotTokenAssemblerResult(EntityPlayer p_i1813_1_, IInventory p_i1813_2_, int p_i1813_3_, int p_i1813_4_, int p_i1813_5_)
    {
