...
public class ItemDarter extends ItemInsect implements IArmorInsect {
	
	private final static Random rand = new Random();
	public final static String NAME = "itemDarter";
	...
	public ItemStack onItemRightClick(ItemStack stack, World par2World, EntityPlayer player)
    {
		...
		player.addPotionEffect(new PotionEffect(Potion.jump.id, 600, 2));
