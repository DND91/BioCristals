...
public class ItemLifeShader extends ItemInsect implements IArmorInsect {
	
	private final static Random rand = new Random();
	public final static String NAME = "itemLifeShader";
	
	public ItemLifeShader(){
		super(EnumResource.BIOMASS, 1.0D, 1.0D, true);
	...
	public void onArmorTick(World world, EntityPlayer player,
		...
		if(!player.worldObj.isRemote && GameEvents.tickServer % 80 == 0){
	...
	public boolean shouldWork(World world, EntityPlayer player,
		...
		return stack.getItemDamage() < stack.getMaxDamage() && player.getHealth() < player.getMaxHealth();
	}
