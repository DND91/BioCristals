...
public class ItemSprinter extends ItemInsect implements IArmorInsect {
	
	private final static Random rand = new Random();
	public final static String NAME = "itemSprinter";
	public static final UUID speedBoostUUID = UUID.fromString("a3f482ce-5b63-4689-81d3-a1956f0ab081");
	public static final AttributeModifier speedBoostModifier = (new AttributeModifier(speedBoostUUID, "Movement Speed Increase", 1.0D, 1));
	...
	public ItemSprinter(){
		...
		this.registerModifier(this, SharedMonsterAttributes.movementSpeed, speedBoostModifier, false);
	}
