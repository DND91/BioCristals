...
public class ItemWaterHunter extends ItemInsect implements IArmorInsect {
	
	private final static Random rand = new Random();
	public final static String NAME = "itemWaterHunter";
	
	public ItemWaterHunter(){
	...
	public ItemStack onItemRightClick(ItemStack stack, World par2World, EntityPlayer player)
    {
		...
		player.addPotionEffect(new PotionEffect(Potion.waterBreathing.id, 600, 2));
	...
	private final double speed = 2.5F;
	...
	public void onArmorTick(World world, EntityPlayer player,
		...
		if(player.isInWater()){
			if(player.moveForward != 0.0F){
				...
				player.motionY *= 1.5F;
				player.motionZ *= 1.5F;
				player.motionX = MathHelper.clamp_double(player.motionX, -speed, speed);
				player.motionY = MathHelper.clamp_double(player.motionY, -speed, speed);
				player.motionZ = MathHelper.clamp_double(player.motionZ, -speed, speed);
			}
